...
namespace Scripts.Infrastructure.Factories.Controllers.UI.AudioSources
{
    public class AudioSourceUIPresenterFactory
    {
            ...
            IAudioSourceUI audioSourceUI)
        {
            ...
            return new AudioSourceUIPresenter(
                audioSourceActivator,
                audioSourceUI,
                _volumeService,
                _pauseService);
        }
            ...
            IDoubleAudioSourceUI audioSourceUI)
        {
            ...
            return new DoubleAudioSourceUIPresenter(
                audioSourceActivator,
                audioSourceUI,
                _pauseService,
                _volumeService);
            ...
            ITripleAudioSourceUI audioSourceUI)
        {
            ...
            return new TripleAudioSourceUIPresenter(
                audioSourceActivator,
                audioSourceUI,
                _volumeService);
        }
            ...
            IFourthAudioSourceUI audioSourceUI)
        {
            ...
            return new FourthAudioSourceUIPresenter(
                audioSourceActivator,
                audioSourceUI,
                _volumeService);
        }
            ...
            IAudioSourceUI audioSourceUI)
        {
            ...
            return new DoubleCallbackAudioSourceUIPresenter(
                audioSourceActivator,
                audioSourceUI,
                _pauseService,
                _volumeService);
            ...
            ITripleAudioSourceUI tripleAudioSourceUI)
        {
            ...
            return new FourthCallBackAudioSourceUIPresenter(
                audioSourceActivator,
                tripleAudioSourceUI,
                _pauseService,
                _volumeService);
