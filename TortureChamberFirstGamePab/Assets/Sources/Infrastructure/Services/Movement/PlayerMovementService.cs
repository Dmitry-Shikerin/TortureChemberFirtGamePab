...
namespace Sources.Infrastructure.Services.Movement
{
    public class PlayerMovementService : IMovementService
    {
        ...
        {
            return _playerMovementCharacteristic.AngularSpeed * Time.deltaTime;
        }

        public float GetMaxSpeed(PlayerInput playerInput, float currentAnimationSpeed, float runInput)
        {
            var maxMovementValue = playerInput.Direction.magnitude;
        ...
        public float GetSpeed(float runInput, float currentSpeed, PlayerInput playerInput)
        {
            ...
            var speed = runInput == 0 ? _playerMovementCharacteristic.RunSpeed : MovementSpeed;
        ...
        {
            var direction = currentSpeed * Time.deltaTime * cameraDirection;
        ...
        {
            return playerInput.Direction.Approximately();
        }
    }
}